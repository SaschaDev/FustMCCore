...
public class InlineKeyboardButton implements Serializable {
    ...
    private String text;
    private String url;
    private com.pengrad.telegrambot.model.request.LoginUrl login_url;
    private String callback_data;
    private String switch_inline_query;
    private String switch_inline_query_current_chat;
    private com.pengrad.telegrambot.model.request.CallbackGame callback_game;
    private Boolean pay;
    ...
    public InlineKeyboardButton callbackGame(String callbackGame) {
        callback_game = new com.pengrad.telegrambot.model.request.CallbackGame();
        return this;
    }
