...
public class ReplyKeyboardMarkup extends Keyboard implements Serializable {
    ...
    private final com.pengrad.telegrambot.model.request.KeyboardButton[][] keyboard;
    ...
    public ReplyKeyboardMarkup(String[][] keyboard, boolean resize_keyboard, boolean one_time_keyboard, boolean selective) {
        com.pengrad.telegrambot.model.request.KeyboardButton[][] keyboardButtons = new com.pengrad.telegrambot.model.request.KeyboardButton[keyboard.length][];
        for (int i = 0; i < keyboard.length; i++) {
            keyboardButtons[i] = new com.pengrad.telegrambot.model.request.KeyboardButton[keyboard[i].length];
            for (int j = 0; j < keyboard[i].length; j++) {
                keyboardButtons[i][j] = new com.pengrad.telegrambot.model.request.KeyboardButton(keyboard[i][j]);
            }
        }
