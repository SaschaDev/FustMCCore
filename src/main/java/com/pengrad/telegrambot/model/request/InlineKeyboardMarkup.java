...
public class InlineKeyboardMarkup extends Keyboard implements Serializable {
    ...
    private final com.pengrad.telegrambot.model.request.InlineKeyboardButton[][] inline_keyboard;

    public InlineKeyboardMarkup(com.pengrad.telegrambot.model.request.InlineKeyboardButton[]... keyboard) {
