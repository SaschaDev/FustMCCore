...
public class EncryptedPassportElement implements Serializable {
    ...
    private com.pengrad.telegrambot.passport.PassportFile[] files;
    private com.pengrad.telegrambot.passport.PassportFile front_side;
    private com.pengrad.telegrambot.passport.PassportFile reverse_side;
    private com.pengrad.telegrambot.passport.PassportFile selfie;
    private com.pengrad.telegrambot.passport.PassportFile[] translation;
    private String hash;

    public com.pengrad.telegrambot.passport.DecryptedData decryptData(com.pengrad.telegrambot.passport.Credentials credentials) throws Exception {
        Class<? extends com.pengrad.telegrambot.passport.DecryptedData> clazz = dataClass();
        if (clazz == null || data == null) return null;
        com.pengrad.telegrambot.passport.SecureValue secureValue = credentials.secureData().ofType(type);
    ...
    public byte[] decryptFile(com.pengrad.telegrambot.passport.PassportFile passportFile, com.pengrad.telegrambot.passport.FileCredentials fileCredentials, TelegramBot bot) throws Exception {
    ...
    public byte[] decryptFile(com.pengrad.telegrambot.passport.PassportFile passportFile, com.pengrad.telegrambot.passport.Credentials credentials, TelegramBot bot) throws Exception {
        com.pengrad.telegrambot.passport.FileCredentials fileCredentials = findFileCredentials(passportFile, credentials);
    ...
    public byte[] decryptFile(byte[] fileData, com.pengrad.telegrambot.passport.FileCredentials fileCredentials) throws Exception {
        return Decrypt.decryptFile(fileData, fileCredentials.fileHash(), fileCredentials.secret());
    }

    private FileCredentials findFileCredentials(com.pengrad.telegrambot.passport.PassportFile passportFile, Credentials credentials) {
    ...
    private Class<? extends DecryptedData> dataClass() {
        ...
        if (Type.passport == type) return com.pengrad.telegrambot.passport.IdDocumentData.class;
        if (Type.internal_passport == type) return com.pengrad.telegrambot.passport.IdDocumentData.class;
        if (Type.driver_license == type) return com.pengrad.telegrambot.passport.IdDocumentData.class;
    ...
    public com.pengrad.telegrambot.passport.PassportFile[] files() {
        return files;
    }

    public com.pengrad.telegrambot.passport.PassportFile frontSide() {
        return front_side;
    }

    public com.pengrad.telegrambot.passport.PassportFile reverseSide() {
        return reverse_side;
    }

    public com.pengrad.telegrambot.passport.PassportFile selfie() {
        return selfie;
    }
